...
**supervised machine learning (regression)** techniques.

The objective is to support **farmers and decision-makers** by providing a data-driven
price recommendation based on historical market prices, seasonal patterns, location, and
